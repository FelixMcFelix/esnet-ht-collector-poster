...
%	\begin{wrapfigure}[6]{r}{.3\linewidth}
	...
	The ingress pipeline then has a peak capacity of \textbf{\SI{55.8}{\giga\bit\per\second} between all flows}, and \textbf{\SIrange{22.3}{34.9}{\giga\bit\per\second} per flow} (depending on which analyses are performed). Deployment machines will be considerably more powerful, and experiments in \emph{Rust} suggest higher parsing throughout.
